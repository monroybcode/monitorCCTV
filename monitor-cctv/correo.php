													...
													<tr>
														<td align="center" valign="top" width="500" class="flexibleContainerCell">
															...
															<table border="0" cellpadding="30" cellspacing="0" width="100%">
																<tr>
                                                                                                                                    <td align="center" valign="top" class="textContent" style="background-color: #F8F8F8">
                                                                                                                                            <img src="resources/images/air.png" width="40%"></img>
																	</td>
																</tr>
															</table>
															<!-- // CONTENT TABLE -->
												...
												<table border="0" cellpadding="30" cellspacing="0" width="500" class="flexibleContainer">
													<tr>
														<td valign="top" width="500" class="flexibleContainerCell">
															...
															<!-- CONTENT TABLE // -->
                                                                                                                        <p style="font-size: 30px; text-align: center">RESERVA CANCELADA</p>
															<!-- // CONTENT TABLE -->
                                                                                                                        <p style="text-align: center;"> <a href="https://www.airbnb.mx/rooms/18826536?location=San%20Miguel%20de%20Allende&adults=2&children=0&infants=0&guests=2&toddlers=0&check_in=2018-12-07&check_out=2018-12-10&s=SLFLLWCy">Fabulous Centro Suite...Private Courtyard Entrance San Miguel de Allende</a></p>
																			...
																			<tr>
																				<td valign="top" class="textContent">
																					...
																					<div mc:edit="body" style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">
                                                                                                                                                                            <strong>Tu reserva no cumple las condiciones para un reembolso debido a la politica de cancelación de tu anfitrión.</strong>
                                                                                                                                                                            <p>Detalles de cancelación</p>
                                                                                                                                                                            <p><strong>Dia de Compra:</strong> 15/OCT/2018</p>
                                                                                                                                                                            <p><strong>Dias de reservación:</strong> 07/DIC/2018 - 10/DIC/2018</p>
                                                                                                                                                                            <p><strong>Monto por noche:</strong> $2,466.00</p>
                                                                                                                                                                            <p><strong>Reservación a nombre de:</strong> Berenice Ayala Tapia</p>
																...
																<tr>
																	...
																	<td align="right" valign="top" class="flexibleContainerBox" style="background-color:#27ae60;">
																		<table class="flexibleContainerBoxNext" border="0" cellpadding="30" cellspacing="0" width="100%" style="max-width:100%;">
																			<tr>
																				<td align="left" class="textContent">
																					<h3 style="color:#FFFFFF;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:15px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">Sentimos tu cancelación esperamos vuelvas pronto</h3>
															...
															<table border="0" cellpadding="30" cellspacing="0" width="100%">
																<tr>
																	<td valign="top" bgcolor="#E1E1E1">
																		...
																		<div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
																			<div>Copyright &#169; 2018 <a href="https://www.airbnb.mx/?af=43720035&c=.pi0.pk49669630033_229715705976_c_304865403058&gclid=EAIaIQobChMIkOqIlb-u3gIVCA1pCh3migqdEAAYASAAEgJgofD_BwE" target="_blank" style="text-decoration:none;color:#828282;"><span style="color:#828282;">airbnb</span></a>. All&nbsp;rights&nbsp;reserved.</div>
