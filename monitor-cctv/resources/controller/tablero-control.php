...
where true and t.estatus!=3 and t.usuario_actual='" . $_SESSION['id_usuario'] . "'";
...
$query = "select count(t.id_ticket) as total_pendientes_asignar
from tickets t
JOIN usuario_hospital uh on t.unidad_negocio=uh.hospital and uh.usuario='" . $_SESSION['id_usuario'] . "' 
where estatus = 1 and (t.usuario_actual = '' or t.usuario_actual is null)";
$resultado = $mysqli->query($query);
$fila = $resultado->fetch_assoc();
$total_pendientes_asignar = $fila['total_pendientes_asignar'];

//--Resueltos
$query = "select count(t.id_ticket) as total_resueltos
from tickets t
JOIN usuario_hospital uh on t.unidad_negocio=uh.hospital and uh.usuario='" . $_SESSION['id_usuario'] . "' 
where t.estatus = 2 or t.estatus = 3";
$resultado = $mysqli->query($query);
$fila = $resultado->fetch_assoc();
...
from tickets t
JOIN usuario_hospital uh on t.unidad_negocio=uh.hospital and uh.usuario='" . $_SESSION['id_usuario'] . "' 
where t.fecha_registro between '" . $anioGraf . "-01-01 00:00:00' and '" . $anioGraf . "-12-31 23:59:59'
...
and t.ultima_actualizacion between '" . $anioGraf . "-01-01 00:00:00' and '" . $anioGraf . "-12-31 23:59:59'
                        ...
                        <div class="col-lg-3 col-xs-6">
                            <a id="lnkAsignadosMi" href="#">
                                <div class="small-box bg-blue-gradient">
                                    <div class="inner">
                                        <h3><?php echo $total_asignadas_a_mi; ?></h3>
                                        <p>Asignadas a mi</p>
                                    </div>
                                    <div class="icon">
