...
if ($id_ticket != "") {
    ...
    $query = "select t.categoria_2, t.categoria_3, t.categoria_4, t.unidad_negocio 
        from tickets t 
    ...
    if ($numRegistros > 0) {
        regresarFlujoProceso($id_ticket, $rs['id_usuario_responsable'], $sigEtapaFP);
        echo "resuelta";
    } else {
        echo "error";
    }
...
function regresarFlujoProceso($idTicket, $idUsrResponsable, $etapaAnteriorFP) {
    require '../connection/conexion.php';
    $mysqli->query("SET NAMES 'UTF8'");
