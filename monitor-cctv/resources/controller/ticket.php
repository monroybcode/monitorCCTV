...
//                }
    ...
    <body class="skin-blue sidebar-mini wysihtml5-supported fixed sidebar-collapse">
        ...
        if (($filaVal['total'] > 0) || (in_array("ver_detalle_ticket_completo", isset($_SESSION['funciones']) ? $_SESSION['funciones'] : array()))) {
            ...
            $sql2 = "select * from usr_ticketauto where id_ticket='$id_ticket'";
            ...
            $porciones_3 = explode("<br>-", $cadena_res);
            $cantidad = count($porciones_3);

            $otros = '';
            for ($i = 2; $i < $cantidad; $i++) {
                $otros .= "<br>-" . $porciones_3[$i];
            }
            $cadena_1 = '';

            if (!empty($porciones_3[1])) {

                $cadena_1 = $porciones_3[1];
            }
            ?>
                                ...
                                <section class="det-tick">
                                    ...
                                    <div class="content-data-side">
                                        ...
                                        <div class="box-body side-data">
                                            <label style="margin-bottom: 0;"><b class="hidden-xs" style="font-weight: 100;">Area:</b> <span><?php echo ($fila['usuario_asignado'] == "Sin asignar" ? "" : $fila['nombre_grupo']); ?></span></label>
                                    ...
                                    <div class="content-data-side">
                                        ...
                                        <div class="box-body side-data">
                                            ...
                                            <i class="fa fa-building margin-r-5"></i> <span><?php echo $fila['unidad']; ?></span>
                                            <?php echo $otros ?><br><br>
                                            <i class="fa fa-user margin-r-5" style="width: 15px;"></i><label style="width:90px;font-weight:100;">Responsable(s): </label><?php echo "<br>-" . $cadena_1 ?></br>
                                            ...
                                            <div class="tab-pane active" id="tab-notas">
                                                ...
                                                <div class="contenedor-notas">
                                                    ...
                                                    while ($filaN = $resultado_notas->fetch_assoc()) {
                                                        ...
                                                        . solicitante_a($filaN['nombre'], $id_ticket)
                                                        . '<span> - </span>'
                                                        . date_format(date_create($filaN['fecha_registro']), "d/m/Y H:i")
                                                        . '</span>'
                                                        . $controles
                                                        . $file
                                                        . '</b>'
