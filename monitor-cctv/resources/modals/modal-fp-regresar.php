<div class="modal fade" id="mdl-fp-regresar-ticket">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <label>Regresar ticket</label>
                <!--button type="button" class="close" data-dismiss="modal"><span>&times;</span></button-->
            </div>
            <div class="modal-body">
                <form id="frm-fp-regresar-ticket">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="btn-fp-regresar-ticket">Aplicar</button>
