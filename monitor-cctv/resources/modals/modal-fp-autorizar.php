<div class="modal fade" id="mdl-fp-autorizar-ticket">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="frm-fp-autorizar-ticket">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="btn-fp-autorizar-ticket">Aplicar</button>
